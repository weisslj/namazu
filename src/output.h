 ...
 *
 *   Created: Thu Dec  9 09:17:53 1999
 */
#ifndef __CEXTRACT__
#if __STDC__
...
extern void put_query ( char * qs, int w );
extern void put_page_index ( int n );
extern void put_current_range ( int listmax );
extern void html_print ( char *str );
extern void print_msgfile ( char *fname );
extern void print_hlist ( NmzResult hlist );
